...
public class SwerveTypeConstants {
    ...
    public SwerveTypeConstants(double wheelDiameter, double angleKp, double angleKi, double angleKd, double angleKf, double angleGearRatio, double driveGearRatio, InvertedValue driveMotorInvert, InvertedValue angleMotorInvert, SensorDirectionValue CANCODERInvert) {
